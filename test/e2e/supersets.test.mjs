...
await page.click('.next-start[data-tid]');   // Today's hero: start the next routine
...
console.log('\n── Colours survive minimising and reopening the workout ──');
await page.click('#awBackBtn');
await page.waitForSelector('#miniBar.visible');
await page.click('#miniBar');
await page.waitForSelector('#activeWorkout.visible');
await page.waitForTimeout(300);
